...
import { XMarkIcon, ClockIcon, Squares2X2Icon, FilmIcon, DocumentTextIcon, MagnifyingGlassIcon } from '@heroicons/react/24/outline';
            ...
            <div>
                <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-6">
                        <h1 className="text-4xl font-bold tracking-tight text-gray-900 w-1/4">Khóa học</h1>
                        <div className='ml-9 flex-1 flex justify-between items-center'>
                            <form className="flex items-center w-1/2"
                                onSubmit={async (e: any) => {
                                    e.preventDefault()
                                    setLoading(true)
                                    await courseApi.searchCourse(searchInput).then((data: any) => {
