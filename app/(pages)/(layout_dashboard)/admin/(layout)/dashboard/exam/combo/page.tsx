...
import { columns } from "@/app/_components/Table/ComboColumns/columns"
...
export default function ExamDashboard() {
    ...
    useEffect(() => {
        async function fetchData() {
            await examApi.getAllCombo('1', '').then((data: any) => setExams(data.data.combos)).catch((err: any) => { })
        }
        fetchData()
    }, [authUser.id, change]);
    ...
    return (
        <div className="">
            <div>
                <div className="">
                    <div className="font-bold text-[#171347] text-lg">Danh sách combo đề thi</div>
